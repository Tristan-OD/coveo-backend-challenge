...
public class SuggestionsResourceTest {
    ...
    public void givenParameters_itShouldSearchForCitiesWithThem() throws Throwable {
        ...
        assertEquals(capturedInput.getQueryString(), queryString);
        assertNull(capturedInput.getLatitude());
        assertNull(capturedInput.getLongitude());
        assertNull(capturedInput.getPage());
